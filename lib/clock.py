...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m""")
        ...
        if port_select == "Y" or port_select == "y":
            ...
            subprocess.call('nmap --script clock-skew '+arg+' '+host_ip+' '+output,shell=True)
            clock(host_ip,desc)      
            ...
            file_name=input("Enter your file name to save:")
            output="-oN"+' '+"output/"+host_ip+"-"+file_name+".txt"
            subprocess.call('nmap --script clock-skew -p '+custom_port+' '+arg+' '+host_ip+' '+output,shell=True)
            clock(host_ip,desc)      
        else:
            os.system('clear')
            print(desc)
