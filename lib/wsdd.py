...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m""")
        ...
        if port_select == "Y" or port_select == "y":
            ...
            subprocess.call('nmap -sV  --script wsdd-discover '+' '+arg+' '+host_ip+' '+output,shell=True)
            wsdd(host_ip,desc)
            ...
            file_name=input("Enter your file name to save:")
            output="-oN"+' '+"output/"+host_ip+"-"+file_name+".txt"
            subprocess.call('nmap  --script wsdd-discover  -p '+' '+custom_port+' '+arg+' '+host_ip+' '+output,shell=True)
            wsdd(host_ip,desc)
        else:
            os.system('clear')
            print(desc)
