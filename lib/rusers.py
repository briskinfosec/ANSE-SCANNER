def rusers(host_ip,desc):
    ...
    print("""\033[37m
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m\033[94m
 +Choose  your NSE script for rusersd RPC service:
...
Download: http://nmap.org/svn/scripts/rusers.nse
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m""")
        ...
        if port_select == "Y" or port_select == "y":
            ...
            subprocess.call('nmap  -sV --script rusers'+' '+arg+' '+host_ip+' '+output,shell=True)
            rusers(host_ip,desc)
            ...
            file_name=input("Enter your file name to save:")
            output="-oN"+' '+"output/"+host_ip+"-"+file_name+".txt"
            subprocess.call('nmap --script rusers -p '+' '+custom_port+' '+arg+' '+host_ip+' '+output,shell=True)
            rusers(host_ip,desc)
        else:
            os.system('clear')
            print(desc)
