def creds(host_ip,desc):
    ...
    print("""\033[37m
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m\033[94m
 +Choose  your NSE script for cerdentials checking
      [1] creds-summary
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m""")
        ...
        if port_select == "Y" or port_select == "y":
            ...
            subprocess.call('nmap --script creds-summary '+' '+arg+' '+host_ip+' '+output,shell=True)
            creds(host_ip,desc)      
            ...
            file_name=input("Enter your file name to save:")
            output="-oN"+' '+"output/"+host_ip+"-"+file_name+".txt"
            subprocess.call('nmap --script creds-summary -p '+custom_port+' '+arg+' '+host_ip+' '+output,shell=True)
            creds(host_ip,desc)      
        else:
            os.system('clear')
            print(desc)
