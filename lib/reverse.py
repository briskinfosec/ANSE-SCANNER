def reverse(host_ip,desc):
    ...
    print("""\033[37m
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m\033[94m
 +Choose  your NSE script for Host:
...
User Summary
Creates a reverse index at the end of scan output showing which hosts run a particular service.
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m""")
        ...
        if port_select == "Y" or port_select == "y":
            ...
            subprocess.call('nmap  -sV --script reverse-index'+' '+arg+' '+host_ip+' '+output,shell=True)
            ...
            file_name=input("Enter your file name to save:")
            output="-oN"+' '+"output/"+host_ip+"-"+file_name+".txt"
            subprocess.call('nmap --script reverse-index -p '+' '+custom_port+' '+arg+' '+host_ip+' '+output,shell=True)
            reverse(host_ip,desc)
        else:
            os.system('clear')
            print(desc)
