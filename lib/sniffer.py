def sniffer(host_ip,desc):
    ...
    print("""\033[37m
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m\033[94m
 +Choose  your NSE script for sniffing Detection:
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m""")
        ...
        if port_select == "Y" or port_select == "y":
            ...
            subprocess.call('nmap  -sV --script sniffer-detect'+' '+arg+' '+host_ip+' '+output,shell=True)
            ...
            file_name=input("Enter your file name to save:")
            output="-oN"+' '+"output/"+host_ip+"-"+file_name+".txt"
            subprocess.call('nmap --script sniffer-detect -p '+' '+custom_port+' '+arg+' '+host_ip+' '+output,shell=True)
            sniffer(host_ip,desc)
        else:
            os.system('clear')
            print(desc)
