def openvas(host_ip,desc):
    ...
    print("""\033[37m
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m\033[94m
 +Choose  your NSE script for OpenVAS vulnerability scanner daemon:
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m""")
    ...
    if option == "1":
        print("""\033[37m
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m\033[94m
File openvas-otp-brute

Script types: portrule
Categories: intrusive, brute
Download: http://nmap.org/svn/scripts/openvas-otp-brute.nse
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\033[0m""")
        ...
        if port_select == "Y" or port_select == "y":
            ...
            subprocess.call('nmap  -sV --script openvas-otp-brute'+' '+arg+' '+host_ip+' '+output,shell=True)
            ...
            file_name=input("Enter your file name to save:")
            output="-oN"+' '+"output/"+host_ip+"-"+file_name+".txt"
            subprocess.call('nmap --script openvas-otp-brute -p '+' '+custom_port+' '+arg+' '+host_ip+' '+output,shell=True)
            openvas(host_ip,desc)
        else:
            os.system('clear')
            print(desc)
